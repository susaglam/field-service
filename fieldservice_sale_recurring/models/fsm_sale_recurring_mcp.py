...
"""Minimal MCP / @ai_tool surface for fieldservice_sale_recurring.
...
class FieldserviceSaleRecurringMcp(models.Model):
    ...
    def action_mcp_read(self, sale_order_id):
        ...
        return {
            ...
            "fsm_recurring_count": rec.fsm_recurring_count,
            "fsm_recurring_ids": [x.id for x in rec.fsm_recurring_ids],
        }
