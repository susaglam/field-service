...
class FSMLocation(models.Model):
    ...
    is_a_distribution = fields.Boolean(
        string="Is a Distribution",
        help="Is A Distribution. Boolean flag — true when the condition holds.",
    )
    dist_parent_id = fields.Many2one(
        "fsm.location",
        string="Distribution Parent",
        help="Dist Parent Id. Linked record reference.",
    )
