...
class FSMPersonSkill(models.Model):
    ...
    skill_id = fields.Many2one(
        ...
        string="Skill",
        required=True,
        help="Skill Id. Linked record reference.",
    )
    skill_level_id = fields.Many2one(
        "hr.skill.level", required=True, help="Skill Level Id. Linked record reference."
    )
    skill_type_id = fields.Many2one(
        "hr.skill.type", required=True, help="Skill Type Id. Linked record reference."
    )
