...
class ResConfigSettings(models.TransientModel):
    ...
    group_fsm_territory = fields.Boolean(
        string="Manage Territory",
        implied_group="fieldservice.group_fsm_territory",
        help="Group Fsm Territory.",
    )

    # Modules
    module_fieldservice_account = fields.Boolean(
        string="Invoice your FSM orders", help="Module Fieldservice Account."
    )
    module_fieldservice_activity = fields.Boolean(
        string="Manage FSM Activities", help="Module Fieldservice Activity."
    )
    module_fieldservice_agreement = fields.Boolean(
        string="Manage Agreements", help="Module Fieldservice Agreement."
    )
    module_fieldservice_change_management = fields.Boolean(
        string="Change Management", help="Module Fieldservice Change Management."
    )
    module_fieldservice_crm = fields.Boolean(
        string="CRM", help="Module Fieldservice Crm."
    )
    module_fieldservice_distribution = fields.Boolean(
        string="Manage Distribution", help="Module Fieldservice Distribution."
    )
    ...
    module_fieldservice_project = fields.Boolean(
        string="Projects and Tasks", help="Module Fieldservice Project."
    )
    ...
    module_fieldservice_recurring = fields.Boolean(
        string="Manage Recurring Orders", help="Module Fieldservice Recurring."
    )
    ...
    module_fieldservice_route = fields.Boolean(
        string="Manage routes", help="Module Fieldservice Route."
    )
    module_fieldservice_sale = fields.Boolean(
        string="Sell FSM orders", help="Module Fieldservice Sale."
    )
    ...
    module_fieldservice_skill = fields.Boolean(
        string="Manage Skills", help="Module Fieldservice Skill."
    )
    module_fieldservice_stock = fields.Boolean(
        string="Use Odoo Logistics", help="Module Fieldservice Stock."
    )
    module_fieldservice_vehicle = fields.Boolean(
        string="Manage Vehicles", help="Module Fieldservice Vehicle."
    )
    module_fieldservice_substatus = fields.Boolean(
        string="Manage Sub-Statuses", help="Module Fieldservice Substatus."
    )
